package com.flaconi.restapp.aop;

import com.flaconi.restapp.controller.exception.InvalidTokenException;
...
public class TokenRequiredAspect {
    ...
    public void tokenRequiredWithAnnotation(TokenRequired tokenRequired) {
        ...
        if (!claims.getSubject().equalsIgnoreCase(subject)) {
            throw new InvalidTokenException("Subject doesn't match in the token");
        }
